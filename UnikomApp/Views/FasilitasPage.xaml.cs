...
{
    public partial class PageFasilitas : PhoneApplicationPage
    {
        bool isOpenNavDraw;
        double marginLeft;
        public PageFasilitas()
        {
            InitializeComponent();
            isOpenNavDraw = false;
            marginLeft = -400;
        ...
        private void Home_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            transactionList.Add(new Transaction("Tempat Parkir", "/Assets/Parking.png"));
            transactionList.Add(new Transaction("Laboratorium", "/Assets/Laboratorium.png"));
            transactionList.Add(new Transaction("Ruang Kelas", "/Assets/Ruangan.png"));
            transactionList.Add(new Transaction("Kartu Mahasiswa", "/Assets/SmartCard.png"));
